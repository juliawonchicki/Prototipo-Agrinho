...
const CULTURAS = {
  graos: {
    ...
    descricao:
      "Soja, milho, trigo, arroz e feijão. A categoria que mais gera receita no agronegócio brasileiro.",
    ...
    causas: [
      {
        texto:
          "Armazenamento com umidade elevada, causando fungos e aflatoxinas nos silos.",
      },
      {
        texto:
          "Transporte em carretas sem cobertura adequada, com perdas por derramamento nas estradas.",
      },
      {
        texto:
          "Infestação de pragas de armazenagem (carunchos, traças) por ausência de monitoramento.",
      },
      {
        texto:
          "Má secagem pós-colheita, elevando a umidade dos grãos acima dos limites seguros.",
      },
      {
        texto:
          "Silos sem sistemas de aeração automatizados, favorecendo o aquecimento da massa de grãos.",
      },
    ],
    solucoes: [
      {
        texto:
          "Sensores de temperatura e umidade em silos com alertas automáticos via SMS/app.",
      },
      {
        texto:
          "Robôs/Secadores inteligentes com controle automatizado de temperatura e fluxo de ar.",
      },
      {
        texto:
          "Roteirização logística com IA para minimizar tempo em trânsito e perdas por vibração.",
      },
      {
        texto:
          "Big Bags biodegradáveis e Sacolas Herméticas reutilizáveis para pequenos produtores.",
      },
      {
        texto:
          "Software de gestão de estoque integrado com previsão de demanda por mercado.",
      },
    ],
    destaque: {
      titulo: "Sensor IoT de Monitoramento de Silos",
      descricao:
        "Dispositivos IoT (Internet das Coisas) instalados dentro dos silos medem continuamente temperatura e umidade da massa de grãos. Ao detectar anomalias, disparam alertas em tempo real para o produtor pelo celular — permitindo intervenção antes que o dano se alastre para toda a carga.",
      metricas: [
        {
  ...
  frutas: {
    ...
    descricao:
      "Laranja, banana, maçã, manga, morango e demais frutas frescas de alta perecibilidade.",
    ...
    causas: [
      {
        texto:
          "Quebra da cadeia do frio durante o transporte, acelerando o amadurecimento e a deterioração.",
      },
      {
        texto:
          "Embalagens inadequadas que causam amassamentos, abrasões e pressão excessiva nos frutos.",
      },
      {
        texto:
          "Colheita no ponto errado de maturação, deixando frutas inviáveis para o transporte de longa distância.",
      },
      {
        texto:
          "Estradas com buracos e vibrações excessivas causando danos mecânicos irreversíveis.",
      },
      {
        texto:
          "Falta de estruturas de câmara fria na fazenda para aguardar o escoamento ideal da produção.",
      },
    ],
    solucoes: [
      {
        texto:
          "Câmaras frias modulares de baixo custo para associações de produtores rurais.",
      },
      {
        texto:
          "Embalagens biodegradáveis com espuma natural e amortecimento vegetal para proteção individual.",
      },
      {
        texto:
          "Tecnologia de Atmosfera Controlada (CA) com ajuste de O₂ e CO₂ nos contêineres.",
      },
      {
        texto:
          "App de gestão de colheita com índices de maturação por espécie e destino do mercado.",
      },
      {
        texto:
          "Plataformas de conexão direta produtor-consumidor para reduzir elos logísticos desnecessários.",
      },
    ],
    destaque: {
  ...
  hortalicas: {
    ...
    descricao:
      "Alface, tomate, cenoura, beterraba, pimentão e demais vegetais frescos de alta rotatividade.",
    ...
    causas: [
      {
        texto:
          "Altíssima perecibilidade natural: folhosas podem murchar em menos de 12h sem refrigeração.",
      },
      {
        texto:
          "Excesso de umidade durante a lavagem ou o transporte causa apodrecimento rápido das folhas.",
      },
      {
        texto:
          "Embalagens pesadas demais comprimem os vegetais, causando danos na base da pilha.",
      },
      {
        texto:
          "Falta de previsão de demanda: produção em excesso sem destino certo leva ao descarte no campo.",
      },
      {
        texto:
          "Transporte inadequado misturando hortaliças com produtos que liberam etileno, acelerando a decomposição.",
      },
    ],
    solucoes: [
      {
        texto:
          "Hidrocooling (pré-resfriamento a água) imediatamente após a colheita para reduzir o calor de campo.",
      },
      {
        texto:
          "Caixas plásticas retornáveis (CPRs) padronizadas para eliminar amassamentos no transporte.",
      },
      {
        texto:
          "Revestimentos naturais comestíveis (à base de cera de carnaúba) para prolongar a vida de prateleira.",
      },
      {
        texto:
          "Plataformas digitais de comercialização antecipada (compra na roça) para planejar a colheita.",
      },
      {
        texto:
          "Mini-centrais de abastecimento locais com câmara fria compartilhada por cooperativas.",
      },
    ],
    destaque: {
  ...
  laticinios: {
    ...
    descricao:
      "Leite fluido, queijos, iogurtes e manteiga. Produtos com cadeia do frio crítica e prazos curtos.",
    taxaDesperdicio: 0.2,
    precoMedio: 4800,
    ...
    causas: [
      {
        texto:
          "Quebra da cadeia do frio na coleta do leite, especialmente em pequenos produtores sem tanque refrigerado.",
      },
      {
        texto:
          "Higienização insuficiente de equipamentos de ordenha e tanques, contaminando o leite com bactérias.",
      },
      {
        texto:
          "Falta de controle de qualidade no campo: leite com acidez elevada descartado na indústria.",
      },
      {
        texto:
          "Embalagens com selagem deficiente permitindo entrada de ar e aceleração da oxidação.",
      },
      {
        texto:
          "Superprodução em períodos de entressafra sem planejamento para derivados (queijo, manteiga).",
      },
    ],
    solucoes: [
      {
        texto:
          "Tanques de resfriamento a granel para associações de pequenos produtores com energia solar.",
      },
      {
        texto:
          "Sensores de temperatura integrados à coleta: motorista recebe alerta se o leite estiver fora do padrão.",
      },
      {
        texto:
          "App de controle de qualidade em campo: o próprio produtor testa acidez e pH via kit portátil.",
      },
      {
        texto:
          "Aproveitamento do leite fora do padrão para produção de biogás e biofertilizante.",
      },
      {
        texto:
          "Orientação técnica para transformação em derivados de maior vida útil (queijo, ricota) em períodos de excesso.",
      },
    ],
    destaque: {
  ...
  carnes: {
    ...
    descricao:
      "Carne bovina, suína, de frango e pescados. Alta densidade proteica e cadeia logística complexa.",
    ...
    causas: [
      {
        texto:
          "Transporte em temperaturas acima do limite seguro (acima de 4°C para carnes frescas) contamina o produto.",
      },
      {
        texto:
          "Logística lenta entre frigoríficos e distribuidoras aumenta o tempo de exposição e o risco de deterioração.",
      },
      {
        texto:
          "Embalagens a vácuo com falha de selagem permitem entrada de oxigênio e crescimento bacteriano acelerado.",
      },
      {
        texto:
          "Rastreabilidade deficiente impede identificar o ponto de falha quando há lote rejeitado.",
      },
      {
        texto:
          "Gestão de validade manual em açougues e supermercados leva a estoques com datas vencidas não percebidas.",
      },
    ],
    solucoes: [
      {
        texto:
          "Embalagens com indicadores de temperatura integrados (etiquetas termocromáticas) visíveis ao consumidor.",
      },
      {
        texto:
          "Rastreabilidade via QR Code ou blockchain: do boi ao prato, visível por qualquer consumidor.",
      },
      {
        texto:
          "Veículos refrigerados com monitoramento IoT e alarme automático de temperatura para o motorista.",
      },
      {
        texto:
          "Sistemas de gestão de validade com IA em câmaras frigoríficas — priorizando saída pelo prazo (FEFO).",
      },
      {
        texto:
          "Aproveitamento de cortes fora do padrão estético para produção de proteína processada, evitando descarte.",
      },
    ],
    destaque: {
      titulo: "Rastreabilidade por QR Code e Blockchain",
      descricao:
        "Cada lote de carne recebe um QR Code que registra todo o histórico em um sistema de blockchain: fazenda de origem, data de abate, temperatura de cada etapa logística, data de embalagem e prazo de validade. O consumidor escaneia com o celular e vê todo o trajeto. Em caso de anomalia de temperatura, o sistema emite alerta automático e bloqueia o lote antes que chegue à gôndola.",
      metricas: [
        {
