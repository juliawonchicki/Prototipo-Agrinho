...
const CULTURAS = {
  graos: {
    ...
    co2PorTonelada: 1.2,
    causas: [
      { imgSrc: 'imagens/icone-temperatura.svg',  imgAlt: 'Termômetro',    texto: 'Armazenamento com umidade elevada, causando fungos e aflatoxinas nos silos.' },
      { imgSrc: 'imagens/icone-caminhao.svg',      imgAlt: 'Caminhão',      texto: 'Transporte em carretas sem cobertura adequada, com perdas por derramamento nas estradas.' },
      { imgSrc: 'imagens/icone-praga.svg',         imgAlt: 'Inseto',        texto: 'Infestação de pragas de armazenagem (carunchos, traças) por ausência de monitoramento.' },
      { imgSrc: 'imagens/icone-secagem.svg',       imgAlt: 'Gota de água',  texto: 'Má secagem pós-colheita, elevando a umidade dos grãos acima dos limites seguros.' },
      { imgSrc: 'imagens/icone-engrenagem.svg',    imgAlt: 'Engrenagem',    texto: 'Silos sem sistemas de aeração automatizados, favorecendo o aquecimento da massa de grãos.' },
    ],
    solucoes: [
      { imgSrc: 'imagens/sol-sensor.svg',          imgAlt: 'Sensor IoT',    texto: 'Sensores de temperatura e umidade em silos com alertas automáticos via SMS/app.' },
      { imgSrc: 'imagens/sol-robo.svg',            imgAlt: 'Robô',          texto: 'Secadores inteligentes com controle automatizado de temperatura e fluxo de ar.' },
      { imgSrc: 'imagens/sol-rota.svg',            imgAlt: 'Mapa de rota',  texto: 'Roteirização logística com IA para minimizar tempo em trânsito e perdas por vibração.' },
      { imgSrc: 'imagens/sol-embalagem-bio.svg',   imgAlt: 'Embalagem',     texto: 'Big Bags biodegradáveis e Sacolas Herméticas reutilizáveis para pequenos produtores.' },
      { imgSrc: 'imagens/sol-software.svg',        imgAlt: 'Gráfico',       texto: 'Software de gestão de estoque integrado com previsão de demanda por mercado.' },
    ],
    destaque: {
      ...
      metricas: [
        { imgSrc: 'imagens/met-reducao.svg',  imgAlt: 'Seta para baixo', texto: 'Reduz perdas em até 60%' },
        { imgSrc: 'imagens/met-dinheiro.svg', imgAlt: 'Cifra de dinheiro', texto: 'ROI médio em 18 meses' },
        { imgSrc: 'imagens/met-folha.svg',    imgAlt: 'Folha verde', texto: 'Tecnologia adaptável a pequenas fazendas' },
      ],
    },
  },
  ...
  frutas: {
    ...
    co2PorTonelada: 2.5,
    causas: [
      { imgSrc: 'imagens/icone-temperatura.svg',  imgAlt: 'Termômetro',         texto: 'Quebra da cadeia do frio durante o transporte, acelerando o amadurecimento e a deterioração.' },
      { imgSrc: 'imagens/icone-embalagem.svg',    imgAlt: 'Caixa',              texto: 'Embalagens inadequadas que causam amassamentos, abrasões e pressão excessiva nos frutos.' },
      { imgSrc: 'imagens/icone-relogio.svg',      imgAlt: 'Relógio',            texto: 'Colheita no ponto errado de maturação, deixando frutas inviáveis para o transporte de longa distância.' },
      { imgSrc: 'imagens/icone-estrada.svg',      imgAlt: 'Estrada',            texto: 'Estradas com buracos e vibrações excessivas causando danos mecânicos irreversíveis.' },
      { imgSrc: 'imagens/icone-fabrica.svg',      imgAlt: 'Armazém',            texto: 'Falta de estruturas de câmara fria na fazenda para aguardar o escoamento ideal da produção.' },
    ],
    solucoes: [
      { imgSrc: 'imagens/sol-camara-fria.svg',    imgAlt: 'Câmara fria',        texto: 'Câmaras frias modulares de baixo custo para associações de produtores rurais.' },
      { imgSrc: 'imagens/sol-embalagem-bio.svg',  imgAlt: 'Embalagem verde',    texto: 'Embalagens biodegradáveis com espuma natural e amortecimento vegetal para proteção individual.' },
      { imgSrc: 'imagens/sol-atmosfera.svg',      imgAlt: 'Molécula de ar',     texto: 'Tecnologia de Atmosfera Controlada (CA) com ajuste de O₂ e CO₂ nos contêineres.' },
      { imgSrc: 'imagens/sol-app.svg',            imgAlt: 'Celular com app',    texto: 'App de gestão de colheita com índices de maturação por espécie e destino do mercado.' },
      { imgSrc: 'imagens/sol-parceria.svg',       imgAlt: 'Aperto de mão',      texto: 'Plataformas de conexão direta produtor-consumidor para reduzir elos logísticos desnecessários.' },
    ],
    destaque: {
      ...
      metricas: [
        { imgSrc: 'imagens/met-calendario.svg', imgAlt: 'Calendário',    texto: 'Vida útil estendida em até 6x' },
        { imgSrc: 'imagens/met-proibido.svg',   imgAlt: 'Símbolo de não', texto: 'Sem conservantes químicos' },
        { imgSrc: 'imagens/met-reciclagem.svg', imgAlt: 'Reciclagem',    texto: 'Compatível com produção orgânica' },
      ],
    },
  },
  ...
  hortalicas: {
    ...
    co2PorTonelada: 1.8,
    causas: [
      { imgSrc: 'imagens/icone-relogio.svg',      imgAlt: 'Relógio',            texto: 'Altíssima perecibilidade natural: folhosas podem murchar em menos de 12h sem refrigeração.' },
      { imgSrc: 'imagens/icone-chuva.svg',        imgAlt: 'Nuvem com chuva',    texto: 'Excesso de umidade durante a lavagem ou o transporte causa apodrecimento rápido das folhas.' },
      { imgSrc: 'imagens/icone-embalagem.svg',    imgAlt: 'Caixa pesada',       texto: 'Embalagens pesadas demais comprimem os vegetais, causando danos na base da pilha.' },
      { imgSrc: 'imagens/icone-secagem.svg',      imgAlt: 'Gráfico caindo',     texto: 'Falta de previsão de demanda: produção em excesso sem destino certo leva ao descarte no campo.' },
      { imgSrc: 'imagens/icone-caminhao.svg',     imgAlt: 'Caminhão',           texto: 'Transporte inadequado misturando hortaliças com produtos que liberam etileno, acelerando a decomposição.' },
    ],
    solucoes: [
      { imgSrc: 'imagens/sol-hidro.svg',          imgAlt: 'Gota de água fria',  texto: 'Hidrocooling (pré-resfriamento a água) imediatamente após a colheita para reduzir o calor de campo.' },
      { imgSrc: 'imagens/sol-caixa-retornavel.svg', imgAlt: 'Caixa retornável', texto: 'Caixas plásticas retornáveis (CPRs) padronizadas para eliminar amassamentos no transporte.' },
      { imgSrc: 'imagens/sol-revestimento.svg',   imgAlt: 'Fruto com camada',   texto: 'Revestimentos naturais comestíveis (à base de cera de carnaúba) para prolongar a vida de prateleira.' },
      { imgSrc: 'imagens/sol-app.svg',            imgAlt: 'Celular com app',    texto: 'Plataformas digitais de comercialização antecipada (compra na roça) para planejar a colheita.' },
      { imgSrc: 'imagens/sol-central.svg',        imgAlt: 'Armazém local',      texto: 'Mini-centrais de abastecimento locais com câmara fria compartilhada por cooperativas.' },
    ],
    destaque: {
      ...
      metricas: [
        { imgSrc: 'imagens/met-folha.svg',      imgAlt: 'Folha verde',   texto: '100% natural e comestível' },
        { imgSrc: 'imagens/met-calendario.svg', imgAlt: 'Calendário',    texto: 'Prateleira até 3x mais longa' },
        { imgSrc: 'imagens/met-brasil.svg',     imgAlt: 'Mapa do Brasil', texto: 'Matéria-prima 100% brasileira' },
      ],
    },
  },
  ...
  laticinios: {
    ...
    taxaDesperdicio: 0.20,
    precoMedio: 4800,
    aguaVirtualPorTonelada: 1020,
    co2PorTonelada: 3.2,
    causas: [
      { imgSrc: 'imagens/icone-temperatura.svg',  imgAlt: 'Termômetro',    texto: 'Quebra da cadeia do frio na coleta do leite, especialmente em pequenos produtores sem tanque refrigerado.' },
      { imgSrc: 'imagens/icone-bacteria.svg',     imgAlt: 'Bactéria',      texto: 'Higienização insuficiente de equipamentos de ordenha e tanques, contaminando o leite com bactérias.' },
      { imgSrc: 'imagens/icone-gestao.svg',       imgAlt: 'Prancheta',     texto: 'Falta de controle de qualidade no campo: leite com acidez elevada descartado na indústria.' },
      { imgSrc: 'imagens/icone-embalagem.svg',    imgAlt: 'Embalagem',     texto: 'Embalagens com selagem deficiente permitindo entrada de ar e aceleração da oxidação.' },
      { imgSrc: 'imagens/icone-secagem.svg',      imgAlt: 'Gráfico',       texto: 'Superprodução em períodos de entressafra sem planejamento para derivados (queijo, manteiga).' },
    ],
    solucoes: [
      { imgSrc: 'imagens/sol-tanque-solar.svg',   imgAlt: 'Tanque com painel solar', texto: 'Tanques de resfriamento a granel para associações de pequenos produtores com energia solar.' },
      { imgSrc: 'imagens/sol-sensor.svg',         imgAlt: 'Sensor',        texto: 'Sensores de temperatura integrados à coleta: motorista recebe alerta se o leite estiver fora do padrão.' },
      { imgSrc: 'imagens/sol-app.svg',            imgAlt: 'Celular com app', texto: 'App de controle de qualidade em campo: o próprio produtor testa acidez e pH via kit portátil.' },
      { imgSrc: 'imagens/sol-biogás.svg',         imgAlt: 'Reciclagem',    texto: 'Aproveitamento do leite fora do padrão para produção de biogás e biofertilizante.' },
      { imgSrc: 'imagens/sol-derivados.svg',      imgAlt: 'Queijo',        texto: 'Orientação técnica para transformação em derivados de maior vida útil (queijo, ricota) em períodos de excesso.' },
    ],
    destaque: {
      ...
      metricas: [
        { imgSrc: 'imagens/met-solar.svg',      imgAlt: 'Sol',           texto: '100% energia renovável' },
        { imgSrc: 'imagens/met-produtor.svg',   imgAlt: 'Agricultor',    texto: 'Ideal para agricultura familiar' },
        { imgSrc: 'imagens/met-reducao.svg',    imgAlt: 'Seta caindo',   texto: 'Reduz rejeição na indústria em 75%' },
      ],
    },
  },
  ...
  carnes: {
    ...
    co2PorTonelada: 27,
    causas: [
      { imgSrc: 'imagens/icone-temperatura.svg',  imgAlt: 'Termômetro',    texto: 'Transporte em temperaturas acima do limite seguro (acima de 4°C para carnes frescas) contamina o produto.' },
      { imgSrc: 'imagens/icone-relogio.svg',      imgAlt: 'Relógio',       texto: 'Logística lenta entre frigoríficos e distribuidoras aumenta o tempo de exposição e o risco de deterioração.' },
      { imgSrc: 'imagens/icone-embalagem.svg',    imgAlt: 'Embalagem',     texto: 'Embalagens a vácuo com falha de selagem permitem entrada de oxigênio e crescimento bacteriano acelerado.' },
      { imgSrc: 'imagens/icone-gestao.svg',       imgAlt: 'Prancheta',     texto: 'Rastreabilidade deficiente impede identificar o ponto de falha quando há lote rejeitado.' },
      { imgSrc: 'imagens/icone-engrenagem.svg',   imgAlt: 'Engrenagem',    texto: 'Gestão de validade manual em açougues e supermercados leva a estoques com datas vencidas não percebidas.' },
    ],
    solucoes: [
      { imgSrc: 'imagens/sol-etiqueta.svg',       imgAlt: 'Etiqueta inteligente', texto: 'Embalagens com indicadores de temperatura integrados (etiquetas termocromáticas) visíveis ao consumidor.' },
      { imgSrc: 'imagens/sol-qrcode.svg',         imgAlt: 'QR Code',       texto: 'Rastreabilidade via QR Code ou blockchain: do boi ao prato, visível por qualquer consumidor.' },
      { imgSrc: 'imagens/sol-camara-fria.svg',    imgAlt: 'Veículo refrigerado', texto: 'Veículos refrigerados com monitoramento IoT e alarme automático de temperatura para o motorista.' },
      { imgSrc: 'imagens/sol-robo.svg',           imgAlt: 'Robô IA',       texto: 'Sistemas de gestão de validade com IA em câmaras frigoríficas — priorizando saída pelo prazo (FEFO).' },
      { imgSrc: 'imagens/sol-reciclagem.svg',     imgAlt: 'Reciclagem',    texto: 'Aproveitamento de cortes fora do padrão estético para produção de proteína processada, evitando descarte.' },
    ],
    destaque: {
      ...
      metricas: [
        { imgSrc: 'imagens/met-lupa.svg',       imgAlt: 'Lupa',           texto: 'Transparência total ao consumidor' },
        { imgSrc: 'imagens/met-escudo.svg',     imgAlt: 'Escudo',         texto: 'Bloqueio preventivo de lotes suspeitos' },
        { imgSrc: 'imagens/met-grafico-up.svg', imgAlt: 'Gráfico subindo', texto: 'Aumenta confiança e valor do produto' },
      ],
    },
  },
};
...
const CENARIOS = {
  basico:        { fator: 0.30, nome: 'Básico' },
  intermediario: { fator: 0.55, nome: 'Intermediário' },
  avancado:      { fator: 0.80, nome: 'Avançado' },
};
...
function inicializarNavegacao() {
  ...
  document.addEventListener('click', (evento) => {
    const clicouFora = !menuNav.contains(evento.target) && !botaoToggle.contains(evento.target);
...
function calcularImpacto(producaoTon, chavecultura, chaveCenario) {
  ...
  return { alimentoRecuperado, economiaReais, aguaEconomizada, co2Evitado, cultura, cenario };
}
...
function exibirResultados(resultado) {
  ...
  atualizarTextoElemento('resAlimentoSalvo', formatarNumero(resultado.alimentoRecuperado, 2));
  atualizarTextoElemento('resEconomia',      'R$ ' + formatarNumero(resultado.economiaReais, 0));
  atualizarTextoElemento('resAgua',          formatarNumero(resultado.aguaEconomizada, 0));
...
function validarEntradaSimulador() {
  ...
  if (!producao || isNaN(producao) || producao <= 0) {
    mostrarErroInput(inputProducao, 'Por favor, informe uma produção válida (maior que 0).');
    return null;
  }
  if (producao > 100000) {
...
function inicializarSimulador() {
  ...
  if (btnCalcular) {
    btnCalcular.addEventListener('click', () => {
      ...
      if (!dados) return;
      const resultado = calcularImpacto(dados.producao, dados.cultura, dados.cenario);
